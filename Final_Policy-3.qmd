...
3 (age \~12) and Round 4 (age \~15), drawn from an initial sample of
...
1.  **Prediction**: What factors best predict which children will drop
    out of school between ages 12 and 15 in India and Peru?
...
Peru** - children born around 2001-2002 who were surveyed at: - **Round
3 (2009)**: Age approximately 8 years old - **Round 4 (2013)**: Age
...
**3. Country - Peru (p = 0.024)** - Coefficient: -1.91 - Interpretation:
After controlling for other factors, Peru has significantly lower
dropout than India - Suggests important contextual differences (policy,
culture, school quality)
...
**-** Country: Peru **(p = 0.0076**): Peru has higher math scores than
India
...
We add this section to understand which of our 5 variables actually help
predict dropout. This tells us where policy interventions might be most
effective.
...
math at age 12 are at much higher risk of dropping out by age 15.
...
childhood. International Journal of Obesity, 37.
