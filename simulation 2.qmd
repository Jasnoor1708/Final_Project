...
This next chunk generates predicted probabilities for each child under observed baseline conditions. The outcome tells us the predicted dropout rate given current distribution of wealth and test scores.
...
code for putting all the outputs into a table
